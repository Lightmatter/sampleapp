...
ADMINS = (
    ...
    ("Developer", "yourname@lightmatter.com"),
)
...
ROOT_URLCONF = "sampleapp.sampleapp.urls"
...
CONTEXT_PROCESSORS = [
    ...
    "sampleapp.home.context_processors.settings",
...
DJOSER = {
    "SERIALIZERS": {
        "token_create": "sampleapp.account.serializers.TokenCreateSerializer",
    },
...
WAGTAIL_SITE_NAME = 'sampleapp'
WAGTAIL_APPEND_SLASH = 'settings.APPEND_SLASH'
WAGTAILADMIN_NOTIFICATION_FROM_EMAIL = 'wagtail@sampleapp.com'
